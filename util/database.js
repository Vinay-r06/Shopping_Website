...
const sequelize=new Sequelize('node-complete', 'root', 'Mysql0602@', {dialect: 'mysql', host: 'localhost' });           // create new seqeulize instance by calling new Seqeulize....."Sequelize()-->constructor function"
                                                          // different sql engines or database use slightly different sql syntax...
                                                         // so now it will connect to the connection pool..
                                                         // by creating new sequelize object..
module.exports=sequelize;                 // export my sequelize object which is essentially that database connection pool...managed by sequelize...
